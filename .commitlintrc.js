...
module.exports = {
  ...
  rules: {
    ...
    'type-empty': [2, 'never'],
    'type-enum': [2, 'always', [
      'feat', 'fix', 'docs', 'style', 'refactor', 'perf', 'test', 'build', 'ci', 'chore', 'revert', 'improvement', 'release',],
    ],
  },
  prompt: {
    ...
    types: [
      ...
      { value: "revert", name: "revert:   ⏪️  其他修改 | Reverts a previous commit", emoji: ":rewind:" },
    ],
    useEmoji: true,
    emojiAlign: 'center',
    themeColorCode: '',
